...
**Current state**: v4.31.0 — 63 MCP tools, 7800+ tests, schema v42, SQLite + PostgreSQL + InfinityDB backends, neuroscience engine (10 brain-inspired algorithms), tiered memory (HOT/WARM/COLD + auto-tier + domain boundaries), decision intelligence, 7-module handler architecture, Pro bundled in main package (license-gated), Brain Store community marketplace (GitHub-backed).
