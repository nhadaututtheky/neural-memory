...
This project is indexed by GitNexus as **Neural Memory** (15623 symbols, 43823 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
