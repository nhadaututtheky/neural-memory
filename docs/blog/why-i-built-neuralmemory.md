...
Everything is async Python. Storage is pluggable (SQLite default, in-memory for testing). The MCP server exposes 63 tools that any AI assistant can call.

### Numbers

- **1,649 tests** passing
- **63 MCP tools** (remember, recall, context, train, conflicts, health, habits, ...)
