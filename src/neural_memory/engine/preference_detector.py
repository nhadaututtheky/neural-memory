...
_STOPWORDS: frozenset[str] = frozenset([
    "i", "me", "my", "you", "your", "we", "our", "they", "them", "the",
    "a", "an", "is", "am", "are", "was", "were", "be", "been", "being",
    "have", "has", "had", "do", "does", "did", "will", "would", "shall",
    "should", "may", "might", "can", "could", "of", "in", "to", "for",
    "with", "on", "at", "by", "from", "as", "into", "through", "during",
    "before", "after", "above", "below", "between", "out", "off", "over",
    "under", "again", "further", "then", "once", "that", "this", "these",
    "those", "it", "its", "and", "but", "or", "nor", "not", "no", "so",
    "if", "about", "up", "how", "what", "which", "who", "whom", "when",
    "where", "why", "all", "each", "every", "both", "few", "more", "most",
    "some", "any", "such", "than", "too", "very", "just", "also", "now",
    "here", "there", "really", "like", "use", "using", "used", "prefer",
    "preferred", "favorite", "go", "going", "get", "getting", "good",
    "great", "best", "well", "much", "many", "think", "know", "want",
    "need", "said", "told", "asked", "something", "anything", "everything",
    "nothing",
])
...
def detect_preference_signals(
    ...
    patterns = (
        ...
        if role == "user"
        else _ASSISTANT_PREFERENCE_PATTERNS
    )
