...
_CODE_NOISE: frozenset[str] = frozenset(
    {
        ...
        "use", "used", "let", "run", "try", "see", "say", "make", "take",
        "give", "find", "keep", "know", "think", "want", "look", "like",
        # Code identifiers that look like English words
        "json", "yaml", "toml", "xml", "uuid", "uuid4", "deque", "tuple",
        "struct", "enum", "impl", "trait", "async", "await",
        "callback", "middleware",
        "syntax", "parser", "compiler", "runtime", "binary",
        "config", "configs", "schema", "schemas",
        # Data structures — code noise, not topics
        "linked",
        "buffer", "offset", "alias",
        # Literal values — never conversation topics
        "null", "none", "true", "false", "void", "nil", "zero",
        # Python keywords — noise outside of code discussion
        "import", "export", "return", "raise", "yield", "lambda",
        "class", "self", "super", "global", "nonlocal", "except",
        "break", "continue", "finally", "assert", "del",
        ...
        "issue", "ticket", "sprint", "backlog", "roadmap", "milestone",
        # Common abbreviations that survive min_length=4
        "regex", "utils", "props", "params", "args",
        "admin", "attr", "prop",
        # Generic programming terms
        "override", "overload", "polymorph", "abstract",
        "inherit", "encapsul", "recursion", "iteration",
        "singleton", "factory", "decorator", "prototype",
        # Testing — generic noise
        "expect", "mock", "stub", "fixture",
        "coverage", "benchmark", "testcase", "testsuite",
...
def _get_noise_concepts() -> frozenset[str]:
    ...
    try:
        ...
        base = frozenset({
            ...
            "shall", "need", "dare", "ought", "used", "get", "got", "say",
            "said", "make", "made", "know", "think", "see", "want", "come",
            "go", "take", "like", "look", "give", "find", "new", "tell",
        })
