...
_EVENT_STOPWORDS: frozenset[str] = frozenset([
    ...
    "not", "no", "so", "if", "about", "up", "how", "what", "which", "who",
    "when", "where", "why", "all", "each", "every", "both", "some", "any",
    "than", "too", "very", "just", "also", "now", "here", "there",
    "many", "much", "more", "most", "ago", "days", "weeks", "months",
    "years", "time", "first", "last", "recently", "order", "long",
    "did", "happened", "came", "tell", "remind", "remember",
])
